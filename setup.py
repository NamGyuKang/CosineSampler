...
setup(
    name='CosineSampler',
    ext_modules=[
        CUDAExtension('CosineSampler.cosine_sampler_2D', [
            'CosineSampler/cosine_sampler_2d/csrc/cosine_sampler_2d_kernel.cu',
            'CosineSampler/cosine_sampler_2d/csrc/cosine_sampler_2d.cpp',
        ])
    ],
    cmdclass={
