...
_cosine = load(name="_cosine", sources = ['/hdd/kng/CosineSampler/CosineSampler_2d/cosine_sampler_kernel.cu', '/hdd/kng/CosineSampler/CosineSampler_2d/cosine_sampler.cpp'])
...
#     val2 = CosineSampler.apply(cells, grid, padding_mode, align_corners, 'bilinear', False)
...
#     val = grid_sample_temp.grid_sample_2d(cells, grid, step='bilinear', offset=False) 
