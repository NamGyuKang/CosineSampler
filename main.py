...
#     f2_pred = u2_yy + u2_xx + val2.to('cuda') #u2_y + val2.to('cuda')*u2_x -(0.01/np.pi)*u2_xx #u2_y*2 + 5*(val2.to('cuda')**3) - 5*val2.to('cuda') - 0.0001*u2_xx 
...
#     f_pred = u_yy + u_xx + val.to('cuda') #u_y + val.to('cuda')*u_x -(0.01/np.pi)*u_xx #u2_y*2 + 5*(val2.to('cuda')**3) - 5*val2.to('cuda') - 0.0001*u2_xx 
